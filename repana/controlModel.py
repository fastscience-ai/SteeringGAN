...
class ControlBlock(torch.nn.Module):
    ...
    def forward(self, *args, **kwargs):
        ...
        if self.params.operator == None:
            modified = modified # TODO: When we apply operator as GAN, we should use this line and correct accordingly
        else:
            # This is usual steering method by changing hiddenstate as hidden = hidden + alpha* control 
